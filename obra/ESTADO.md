...
> Última actualización: 2026-09-02 17:49 UTC

| | |
|---|---|
| **Fase** | EN PRODUCCIÓN |
| **Palabras escritas** | **108295** / 155000 (69 %) |
| **Palabras restantes** | 46705 |
| **Capítulos escritos** | 92 / 125 |
| **Último capítulo cerrado** | obra/capitulos/092-la-reconstruccion.md |
| **SIGUIENTE CAPÍTULO A ESCRIBIR** | **093** |
| **Media escrita hasta ahora** | 1177 palabras/capítulo |
| **MEDIA NECESARIA DE AQUÍ AL FINAL** | **1415 palabras/capítulo** |

## Ritmo

Quedan **46705 palabras** en **33 capítulos**: una media de
**1415 palabras por capítulo**, que es el ritmo natural de esta novela y
...
Escribe el capítulo 093 siguiendo obra/arquitectura.md, **con una extensión de al menos 1415 palabras** (ver el aviso de ritmo de abajo). Commit y push inmediatamente después. Luego el 94. Sin parar.

## Recordatorio

1. Lee la ficha del capítulo 093 en `obra/arquitectura.md`.
2. Lee `obra/biblia.md` y los dos últimos capítulos escritos para no romper continuidad.
3. Escribe en `obra/capitulos/093-titulo-en-kebab.md`.
4. `bash scripts/estado.sh && git add -A && git commit -m "cap 093: ..." && git push -u origin claude/libro-200k-agentes-automaticos-28lkqx`
